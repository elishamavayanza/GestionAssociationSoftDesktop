...
public class AdminInterface implements RoleInterface {
    ...
    public JFrame createInterface() {
        ...
        // Boutons du menu
        CustomButton gestionUtilisateursBtn = new CustomButton("Gestion des utilisateurs");
        CustomButton gestionAssociationsBtn = new CustomButton("Gestion des associations");
        CustomButton statistiquesBtn = new CustomButton("Statistiques");
        CustomButton parametresBtn = new CustomButton("Paramètres");
